...
export default class Profile extends React.Component {
    ...
    render() {
      return (
          ...
          <h2> {this.state.profile["collection_slug"]}</h2>
          ...
          <div  style={{display: 'flex',textAlign:"center"}}>
            <div style={{ textAlign:"left"}}>
              ...
              <a href={this.state.profile["opensea"]} target="_blank"><img height="500px" width="500px" src={this.state.profile["image_url"]}></img></a>
            </div>
